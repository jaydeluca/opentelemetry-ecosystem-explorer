...
All components must follow accessibility best practices as outlined in `CLAUDE.md`. Key requirements:
...
Refer to `CLAUDE.md` for complete accessibility guidelines.
